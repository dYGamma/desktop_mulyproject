...
//         // Отправляем одно фото, передавая поток файла
//         await bot.sendPhoto(req.files[0].path, content);
//       } else {
//         // Если файлов несколько, формируем медиагруппу,
//         // преобразуя каждый путь в поток
...
//     let mailOptions = {
//       subject: 'Новая заявка на продажу недвижимости',
//       text: content,
//     };
